<form action="{{url('task/save_log')}}" method="post" id="task_log_form">
  ...
  <div class="container-fluid form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class='input-group col-sm-5 date work-log-date' id='from_date_picker'>
        <input type="text" class="form-control" name="log_date" id="log_date" value="{{(isset($edit_log))?$edit_log->log_date:date('Y-m-d')}}" required>
